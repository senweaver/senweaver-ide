...
echo "Name=SenWeaver" >> VoidApp.AppDir/void.desktop && \
...
echo "Exec=senweaver %F" >> VoidApp.AppDir/void.desktop && \
echo "Icon=senweaver" >> VoidApp.AppDir/void.desktop && \
echo "Type=Application" >> VoidApp.AppDir/void.desktop && \
echo "StartupNotify=false" >> VoidApp.AppDir/void.desktop && \
echo "StartupWMClass=SenWeaver" >> VoidApp.AppDir/void.desktop && \
...
echo "Keywords=senweaver;" >> VoidApp.AppDir/void.desktop && \
...
echo "Name=SenWeaver - URL Handler" > VoidApp.AppDir/void-url-handler.desktop && \
...
echo "Exec=senweaver --open-url %U" > VoidApp.AppDir/void-url-handler.desktop && \
echo "Icon=senweaver" > VoidApp.AppDir/void-url-handler.desktop && \
...
echo "Keywords=senweaver;" > VoidApp.AppDir/void-url-handler.desktop && \
