...
import { ICondaEnvDetectorService } from '../../../workbench/contrib/condaEnv/common/condaEnvDetector.js';
import { CondaEnvDetectorService } from '../../../workbench/contrib/condaEnv/node/condaEnvDetector.js';
...
class SharedProcessMain extends Disposable implements IClientConnectionFilter {
	...
	private async initServices(): Promise<IInstantiationService> {
		...
		services.set(ICondaEnvDetectorService, new SyncDescriptor(CondaEnvDetectorService, undefined, true));
	...
	private initChannels(accessor: ServicesAccessor): void {
		...
		// Conda Environment Detector
		const condaEnvDetectorChannel = ProxyChannel.fromService(accessor.get(ICondaEnvDetectorService), this._store);
		this.server.registerChannel('condaEnvDetector', condaEnvDetectorChannel);
	}
