...
SenWeaver separately records basic usage like the number of messages people are sending. If you'd like to disable SenWeaver metrics, you may do so in SenWeaver's Settings.
`;
