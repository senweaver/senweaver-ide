...
export class TestNativeHostService implements INativeHostService {
	...
	async writeClipboardImage(imageData: VSBuffer): Promise<void> { }
	...
	async captureWebviewScreenshot(webContentsId: number): Promise<Uint8Array | undefined> { return undefined; }
}
