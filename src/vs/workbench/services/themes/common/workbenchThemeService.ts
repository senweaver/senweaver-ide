...
export enum ThemeSettingDefaults {
	...
	COLOR_THEME_DARK_OLD = 'Default Dark Modern', // Senweaver changed this from 'Default Dark+'
...
export const COLOR_THEME_DARK_INITIAL_COLORS = { // Senweaver changed this to match dark+
