...
//#region --- Senweaver
import './contrib/senweaver/browser/senweaver.contribution.js'; // Senweaver added this
//#endregion
...
// Chat
// Senweaver - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
...
// Conda Environment
import './contrib/condaEnv/browser/condaEnv.contribution.js';
