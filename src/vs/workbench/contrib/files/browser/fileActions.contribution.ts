...
import { SENWEAVER_OPEN_SETTINGS_ACTION_ID } from '../../senweaver/browser/senweaverSettingsPane.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		...
		title: nls.localize({ key: 'openSenweaver', comment: ['&& denotes a mnemonic'] }, "&&Open SenWeaver Settings"),
	},
	when: ContextKeyExpr.false(), // Hidden: always false condition
	order: 1
});
