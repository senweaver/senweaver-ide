...
export class FilesRenderer implements ICompressibleTreeRenderer<ExplorerItem, FuzzyScore, IFileTemplateData>, IListAccessibilityProvider<ExplorerItem>, IDisposable {
	...
	// // Create senweaver buttons container
	// const senweaverButtonsContainer = DOM.append(container, DOM.$('div'));
	// SenweaverButtonsContainer.style.position = 'absolute'
	// SenweaverButtonsContainer.style.top = '0'
	// SenweaverButtonsContainer.style.right = '0'
	// // const senweaverButtons = DOM.append(senweaverButtonsContainer, DOM.$('span'));
	// // SenweaverButtons.textContent = 'senweaverButtons'
	// // SenweaverButtons.addEventListener('click', () => {
	// // 	console.log('ON CLICK', templateData.currentContext?.children)
	// // })
	// const senweaverLabels = this.labels.create(senweaverButtonsContainer, { supportHighlights: false, supportIcons: false, });
	// SenweaverLabels.element.textContent = 'hi333'
	...
	// Senweaver cares about this function, this is where elements in the tree are rendered
